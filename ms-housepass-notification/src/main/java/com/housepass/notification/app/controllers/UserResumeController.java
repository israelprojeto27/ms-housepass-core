...
import com.housepass.notification.app.service.UserResumeService;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

@Api(value = "UserResumeController", tags = "UserResume", description = "Endpoints do User Resume para o MS Notification")
@RestController
...
public class UserResumeController {
	...
	public @ResponseBody String addUserResume(@RequestBody CreateUserResumeNotificationlDTO dto){
